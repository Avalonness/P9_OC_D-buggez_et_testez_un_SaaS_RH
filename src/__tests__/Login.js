...
describe("Given that I am a user on login page", () => {
  ...
  //Test de la création d'un user

  describe('createUser method', () => {
    test('should create a user and call login method', async () => {
      document.body.innerHTML = LoginUI();
  
      //On Simule le store avec les méthode async
      const store = {
      ...
      //On définit l'onNavigate
      const onNavigate = (pathname) => {
        document.body.innerHTML = ROUTES({ pathname })
      }
      // On créer une instance du Login
